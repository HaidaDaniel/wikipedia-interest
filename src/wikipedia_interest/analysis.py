...
def compare_series(series: list[dict[str, Any]], criterion: str = "balanced") -> dict[str, Any]:
    ...
    return {
        ...
        "eligible_series_count": len(rankings),
        "excluded_series_count": len(excluded_low_confidence),
        "no_eligible_series": not bool(rankings),
        "no_positive_growth_signal": not bool(positive) if rankings else None,
